...
$config = [
     ...
     * example: your-landing-page.com?secret=[YOUR SECRET]
     * 
     * It's recommended to generate a new secret. Use this link to get one in 10 seconds:
     * https://www.random.org/strings/?num=1&len=16&digits=on&upperalpha=on&loweralpha=on&unique=on&format=html&rnd=new
     */
    'secret' => 'iyeiHo5MJ857vHGe',
];
© 2020 GitHub, Inc.
